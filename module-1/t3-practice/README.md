...
Поведение ожидаемое: тк у каждого экземпляра consumer-group-id один и тот же, то они вычитывают разные сообщения из топика, то есть мы распараллелили обработку
